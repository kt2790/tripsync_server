...
fetch join 의 경우 하나의 Entity로 부터 To-Many 관계를 맺고있는 Entity 가 2개 이상 존재할 경우, <br> 
중복된 데이터 발생으로 인한 MultipleBagFetchException 예외가 발생합니다. <br>
이와 같은 이유로 본 프로젝트에 적용하기엔 제한되는 부분이 있어, batch fetch 방식을 도입하여 최적화를 시도하였습니다. <br>
